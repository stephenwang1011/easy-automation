 ...
 * */
public class PensonCenterUnatestedFather extends BaseParpare {
	protected static int timeOut = 0;
	protected static int sleepTime = 0;

	/** 首页上未认证用户的登录操作以及相关数据准备 **/
	public static void UnattestedPensonCenterParpare(ITestContext context, SeleniumUtil seleniumUtil) {
		...
		HomePageHelper.enterPage(seleniumUtil, HomePage.HP_LINK_CENTER);
		PersonCenterPageHelper.waitPensonCenterPageToLoad(timeOut, seleniumUtil);
	}
}
